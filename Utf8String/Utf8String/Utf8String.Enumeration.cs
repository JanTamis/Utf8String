	...
	public sealed partial class Utf8String
	{
		...
		public readonly struct ByteEnumerable : IEnumerable<byte>
		{
			...
			public struct Enumerator : IEnumerator<byte>
			{
				...
				{
					var nextByteIdx = _nextByteIdx;
					var objAsBytes = _obj.AsBytesSkipNullCheck();
				...
				void IEnumerator.Reset() => throw new NotImplementedException("Reset is not implemented by design");
			}
		}
		...
		public readonly struct CharEnumerable : IEnumerable<char>
		{
			...
			public struct Enumerator : IEnumerator<char>
			{
				...
				public bool MoveNext()
				{
					...
					var currentCharPair = _currentCharPair;
					...
					var bytes = _obj.AsBytesSkipNullCheck();
					var nextByteIdx = _nextByteIdx;
					...
					var status = Rune.DecodeFromUtf8(bytes.Slice(nextByteIdx), out var currentRune, out var bytesConsumedJustNow);
					...
					else
					{
						...
						UnicodeUtility.GetUtf16SurrogatesFromSupplementaryPlaneScalar((uint)currentRune.Value, out var leadingCodeUnit, out var trailingCodeUnit);
		...
		public readonly struct RuneEnumerable : IEnumerable<Rune>
		{
			...
			public struct Enumerator : IEnumerator<Rune>
			{
				...
				public bool MoveNext()
				{
					...
					var status = Rune.DecodeFromUtf8(bytes, out _currentRune, out var bytesConsumedJustNow);
					Debug.Assert(status == OperationStatus.Done);
