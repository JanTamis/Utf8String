...
public sealed partial class Utf8String
{
	...
	/// </remarks>
	public Utf8String Normalize(NormalizationForm normalizationForm = NormalizationForm.FormC) => AsSpanSkipNullCheck().Normalize(normalizationForm);

	/// <summary>
	/// Converts this <see cref="Utf8String"/> to a <see langword="char[]"/>.
	/// </summary>
	public char[] ToCharArray() => AsSpanSkipNullCheck().ToCharArray();
	...
	/// </remarks>
	public Utf8String ToLower(CultureInfo culture) => AsSpanSkipNullCheck().ToLower(culture);
	...
	/// input <see cref="Utf8String"/>.
	/// </remarks>
	public Utf8String ToLowerInvariant() => AsSpanSkipNullCheck().ToLowerInvariant();
	...
	/// input <see cref="Utf8String"/>.
	/// </remarks>
	public Utf8String ToUpper(CultureInfo culture) => AsSpanSkipNullCheck().ToUpper(culture);
	...
	/// input <see cref="Utf8String"/>.
	/// </remarks>
	public Utf8String ToUpperInvariant() => AsSpanSkipNullCheck().ToUpperInvariant();
}