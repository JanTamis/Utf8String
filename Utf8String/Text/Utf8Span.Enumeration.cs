	...
	public readonly ref struct CharEnumerable
	{
		...
		public ref struct Enumerator
		{
			...
			public bool MoveNext()
			{
				...
				var status = Rune.DecodeFromUtf8(_remainingUtf8Bytes, out var currentRune, out var bytesConsumed);
	...
	public readonly ref struct RuneEnumerable
	{
		...
		public ref struct Enumerator
		{
			...
			public bool MoveNext()
			{
				...
				var status = Rune.DecodeFromUtf8(_remainingUtf8Bytes, out _currentRune, out var bytesConsumed);
				Debug.Assert(status == OperationStatus.Done, "Somebody fed us invalid data?");
