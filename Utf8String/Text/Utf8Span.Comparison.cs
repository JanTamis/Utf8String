...
public readonly ref partial struct Utf8Span
{
	...
	public bool Contains(Rune value)
	{
		...
		return Bytes.IndexOf(runeBytes.Slice(0, runeBytesWritten)) >= 0;
	}
	...
	{
		return Bytes.IndexOf(value.Bytes) >= 0;
	}
	...
	public bool EndsWith(Rune value)
	{
		...
		return Bytes.EndsWith(runeBytes.Slice(0, runeBytesWritten));
	}
	...
	public bool StartsWith(Rune value)
	{
		...
		return Bytes.StartsWith(runeBytes.Slice(0, runeBytesWritten));
	}
